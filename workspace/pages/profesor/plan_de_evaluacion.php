                            ...
                            <form class="row mt-2" id="lesson">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Materia</label>
                                        <select class="form-control " id="matters_select" name="matter" 
                                             style="width: 100%;">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"  id="years_select" name="year" 
                                            style="width: 100%;">
                                    ...
                                    <table class="asist_table table table-head-fixed text-nowrap table-bordered">
                                        ...
                                        <tbody>
                                            <tr id="tr1">
                                                ...
                                                <td class="p-0 each_cell"><textarea
                                                        name="contenido1">taxonomía, orden de la taxonomía, clasificación de la taxonomia, orden, especie, genero, familia, clase , phynum y reinos.
