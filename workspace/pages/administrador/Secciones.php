            ...
            <section class="content">
                <div class="container-fluid" id="content_itself">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <select id="yearInput" class="form-control ml-1 col-12 col-sm-2">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                    ...
                    <div class="card">
                        <div class="card-h p-2 d-flex">
                            <ul class="nav nav-pills sections_nav">
                                <li class="nav-item"><a class="nav-link active" href="#A" data-toggle="tab">A</a></li>
                                <li class="nav-item"><a class="nav-link " href="#B" data-toggle="tab">B</a></li>
                            </ul>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <article class="each_section tab-pane active" data-section="A" id="A">
                                ...
                                <article class="each_section tab-pane" data-section="B" id="B">
                                    <div class="">
                                        <div class="mx-auto each_section_header">
                ...
                <nav class="nav_fixed">
                    ...
                    <span class="parent_btn_submit ">
                        <input title='Ctrl + s' type="submit" name="save-date" value="Guardar" class="btn_submit p-2 mt-0" id="guardar"></span>
